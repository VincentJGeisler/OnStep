...
// RTC AND HOME BUTTON ------------------------------------- see https://onstep.groups.io/g/main/wiki/Configuration-Controller#RTC_HOME
#define RTC_HOME_BUTTON               ON //    OFF, ON enables DS3231 RTC position storage and home button reset functionality. Option
                                          //         Requires DS3231 RTC module on I2C and home button on RAMPS X+ connector.
...
// ASCOM DRIVER OVERRIDE -------------------------------------- see https://onstep.groups.io/g/main/wiki/Configuration-Mount#ASCOM_OVERRIDE
...
// HORIZON LIMIT OVERRIDE -------------------------------------- SLEW WHERE I DUCKING TELL YOU
#define DISABLE_HORIZON_LIMITS        ON //    OFF, ON Disables ONLY horizon (minAlt) limit checks - overhead limits still work.    Option
                                          //         When ON: Mount ignores horizon limits but keeps overhead safety limits.
